...
apiRouter.post('/presets/select', (req, res) => {
...
apiRouter.get('/sos', (_req, res) => {
    res.json(store.getSOSReports());
});
apiRouter.get('/incidents/:id/sos', (req, res) => {
...
apiRouter.post('/incidents/:id/sos', (req, res) => {
    const incidentId = req.params.id;
...
apiRouter.patch('/incidents/:id/sos/:sosId', (req, res) => {
...
apiRouter.patch('/sos/:sosId', (req, res) => {
    const { sosId } = req.params;
...
apiRouter.get('/damage', (_req, res) => {
    res.json(store.getDamageReports());
});
apiRouter.post('/incidents/:id/damage', (req, res) => {
    const incidentId = req.params.id;
    const incident = store.getIncidentById(incidentId);
...
apiRouter.get('/incidents/:id/priority', (req, res) => {
    const incident = store.getIncidentById(req.params.id);
    if (!incident) {
        return res.status(404).json({ error: 'Incident not found' });
    }
...
apiRouter.get('/priority/weights', (_req, res) => {
    res.json(priorityEngine.getWeights());
});
apiRouter.post('/priority/weights', (req, res) => {
...
apiRouter.get('/satellite/current-result', (_req, res) => {
...
apiRouter.get('/satellite/probe', (req, res) => {
...
apiRouter.post('/satellite/probe', (req, res) => {
...
apiRouter.post('/drone/analyze', upload.single('image'), async (req, res) => {
    ...
    let clientDetections = undefined;
...
apiRouter.post('/drone/demo', (_req, res) => {
...
apiRouter.patch('/resources/:id', (req, res) => {
    const { id } = req.params;
...
apiRouter.get('/incidents/:id/recommendations', (req, res) => {
    const incident = store.getIncidentById(req.params.id);
    if (!incident) {
        return res.status(404).json({ error: 'Incident not found' });
    }
    const rec = resourceService.findOptimalResource(incident, store.getResources(), store.getRoads());
...
apiRouter.post('/incidents/:id/assignments', (req, res) => {
    const incidentId = req.params.id;
...
apiRouter.post('/incidents/:id/override', (req, res) => {
    const incidentId = req.params.id;
    const incident = store.getIncidentById(incidentId);
    if (!incident) {
        return res.status(404).json({ error: 'Incident not found' });
...
apiRouter.post('/resources/recommend', (req, res) => {
...
apiRouter.post('/resources/assign', (req, res) => {
...
apiRouter.get('/shelters', (_req, res) => {
    res.json(store.getShelters());
});
apiRouter.get('/roads', (_req, res) => {
    res.json(store.getRoads());
});
apiRouter.post('/routing/safe-route', (req, res) => {
...
apiRouter.post('/sitrep', (_req, res) => {
